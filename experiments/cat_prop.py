...
import os
from metamod.control import LinearNetEq, LinearNetConstrainedG, CatPropControl
...
def main(argv):
    ...
    parser.add_argument(
        '--save-path', type=str, default="../results/category_prop/")
    parser.add_argument(
    ...
    cost_coef = args["beta"]
    run_name = args["run_name"] + "_" + args["dataset"] + "_beta_"+str(cost_coef)
